...
const validateEnergyBreakdown = require("../middlewares/validateEnergyBreakdown");
...
const energyBreakdownRoute = (app) => {
    ...
    app.post("/energy-breakdowns", validateEnergyBreakdown.validateCreate, energyBreakdownController.createEnergyBreakdown); // Create new energy breakdown
